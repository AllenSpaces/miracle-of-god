...
function M.setHighLight()
	...
	HL("NormalFloat", { fg = colors.DEFAULT, bg = colors.BG })
	...
	HL("@function.builtin", { fg = colors.FUNCTION, italic = true })
	HL("@function.call", { fg = colors.FUNCTION })
	HL("@method", { fg = colors.FUNCTION })
	HL("@method.call", { fg = colors.FUNCTION })
	...
	HL("@keyword.storage", { fg = colors.KEYWORD })
	...
	HL("CurSearch", { fg = colors.BG, bg = colors.PRIMARY })
	...
	HL("DiagnosticVirtualTextHint", { fg = colors.PRIMARY, bg = colors.BG })
	HL("DiagnosticVirtualTextOk", { fg = colors.SUCCESS, bg = colors.BG })
	...
	HL("@markup.link.url", { fg = colors.PRIMARY, underline = true })
	...
	HL("@markup.raw.delimiter", { fg = colors.GRAY })
	...
	HL("GitSignsAddLn", { fg = colors.SUCCESS })
	HL("GitSignsChangeLn", { fg = colors.WARNING })
	HL("GitSignsDeleteLn", { fg = colors.ERROR })
	...
	HL("NvimTreeClosedFolderName", { fg = colors.PRIMARY })
	HL("NvimTreeEmptyFolderName", { fg = colors.GRAY })
	HL("NvimTreeIndentMarker", { fg = colors.GRAY })
	...
	HL("CmpItemAbbrMatchFuzzy", { fg = colors.PRIMARY, bold = true })
	...
	HL("CmpItemMenuDefault", { fg = colors.GRAY })
	...
	HL("CmpPmenuSel", { bg = colors.SELECTION })
