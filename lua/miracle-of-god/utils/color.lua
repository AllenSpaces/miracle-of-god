...
M.COLORS = {
	...
	SECONDARY = "#ffe2ce",    -- 次要色 - 橙色
	SECONDARY_LIGHT = "#fff5f0", -- 浅次要色
	SECONDARY_DARK = "#f0c8a8", -- 深次要色
	SECONDARY_BG = "#2e1a0a", -- 次要色背景
	...
	KEYWORD_LIGHT = "#fff0f5", -- 浅关键字颜色
	KEYWORD_DARK = "#f0a8c8", -- 深关键字颜色
